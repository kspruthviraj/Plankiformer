...
if __name__ == '__main__':
    ...
    abundance.PlotAbundanceSep(args.datapaths, args.outpath)
    feature.PlotFeatureDistribution(args.datapaths, args.outpath, args.selected_features, args.n_bins, args.datapath_labels)
    feature.PlotFeatureHDversusBin(args.datapaths, args.outpath, args.selected_features)
    feature.GlobalHD_feature(args.datapaths, args.outpath, args.n_bins)
    pixel.PlotPixelDistribution(args.datapaths, args.outpath, args.selected_pixels, args.n_bins, args.datapath_labels, args.resized_length)
    pixel.PlotPixelHDversusBin(args.datapaths, args.outpath, args.selected_pixels, args.resized_length)
    pixel.GlobalHD_pixel(args.datapaths, args.outpath, args.n_bins, args.resized_length)